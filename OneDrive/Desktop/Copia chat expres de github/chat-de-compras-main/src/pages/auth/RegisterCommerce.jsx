...
export default function RegisterCommerce() {
  ...
  const { signupCommerce, error: authError } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    setErrorMsg('');
    try {
      await signupCommerce(formData);
      setSent(true);
    } catch (e) {
      setErrorMsg(e.message || 'No se pudo registrar el comercio.');
    } finally {
      setBusy(false);
    }
  };
